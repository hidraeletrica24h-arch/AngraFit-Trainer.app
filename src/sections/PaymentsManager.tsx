...
import { 
  ...
  Clock, TrendingUp, Link as LinkIcon, QrCode
} from 'lucide-react';
        ...
        <DialogContent className="bg-[#111118] border-red-500/30">
          ...
          <div className="space-y-4 mt-4">
            ...
            {formData.method === 'pix' && (
              <div className="space-y-2 animate-fadeInUp">
                ...
                <div className="relative">
                  <QrCode className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-red-500/60" />
                  <Input
                    value={formData.pixKey}
                    onChange={(e) => setFormData({ ...formData, pixKey: e.target.value })}
                    className="pl-9 bg-[#0a0a0f] border-red-500/30 text-white"
            ...
            {formData.method === 'link' && (
              <div className="space-y-2 animate-fadeInUp">
                <Label className="text-gray-400">Link de Pagamento</Label>
                <div className="relative">
                  <LinkIcon className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-red-500/60" />
                  <Input
